...
## Project Structure
    ...
    ├── testapiautosetting_127050  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127050`
...
2. Clone this repo and `cd testapiautosetting_127050`
